...
export function CoachingClient() {
  ...
  useEffect(() => {
    ...
    fetch(`${basePath}/coaching/Coaching.md`)
      ...
      .catch((error) => {
        console.warn('Could not load markdown file, using static content:', error)
    ...
    <div className="prose prose-zinc dark:prose-invert max-w-none">
      <div className="text-zinc-700 dark:text-zinc-300 space-y-8">
        ...
        <section>
          ...
          <div className="my-8 flex justify-center">
            <Image
              src={process.env.NODE_ENV === 'production' ? '/rockfield-tennis-club-website/coaching/images/junior_friday.jpeg' : '/coaching/images/junior_friday.jpeg'}
        ...
        <section className="pt-8 border-t border-zinc-200 dark:border-zinc-700">
          ...
          <div className="my-8 flex justify-center">
            <Image
              src={process.env.NODE_ENV === 'production' ? '/rockfield-tennis-club-website/coaching/images/adult-tennis-camps.jpeg' : '/coaching/images/adult-tennis-camps.jpeg'}
